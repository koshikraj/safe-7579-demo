...
async function getSocketRpcClient(params) {
  const { getSocket: getSocket2, reconnect = true, url } = params;
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-5DDDFS4V.js").then((module) => module.WebSocket);
...
async function recoverPublicKey({ hash, signature }) {
  ...
  if (v === 0 || v === 1)
    v += 27;
  const { secp256k1: secp256k12 } = await import("./secp256k1-IS7FLSXJ.js");
...
//# sourceMappingURL=chunk-LYDXG5YA.js.map
