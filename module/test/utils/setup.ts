...
export const getMockValidator = async () => {
  const ModuleDeployment = await deployments.get('MockValidator')
  return await ethers.getContractAt('MockValidator', ModuleDeployment.address)
}
...
export const getOwnableValidator = async () => {
  const ModuleDeployment = await deployments.get('OwnableValidator')
  return await ethers.getContractAt('OwnableValidator', ModuleDeployment.address)
}
